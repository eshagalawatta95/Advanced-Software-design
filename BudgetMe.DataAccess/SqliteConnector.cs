...
namespace BudgetMe.DataAccess
{
    public static class SqliteConnector
    {
        private static readonly object readWriteLock = new object();
        private static readonly string _databasePath = BudgetMeApplication.AppSettings.SQLiteDatabasePath;
        ...
        public static SQLiteConnection GetConnection
        {
            get
            {
                SQLiteConnection connection = BudgetMeApplication.DependancyContainer.GetInstance<SQLiteConnection>();
